...
class ConnectionSerializer(serializers.ModelSerializer):
    ...
    def get_main_role(self, obj):
        ...
        main_role = obj.role.filter(main_role=True).first()
        if main_role:
    ...
    def get_other_roles(self, obj):
        ...
        other_roles = obj.role.filter(main_role=False, end_date__isnull=True)
    ...
    def get_past_roles(self, obj):
        ...
        past_roles = obj.role.filter(main_role=False, end_date__isnull=False)
